...
use App\Http\Requests\Backend\Main\ItemOutcoming\StoreRequest;
use App\Http\Requests\Backend\Main\ItemOutcoming\UpdateRequest;

class ItemOutcomingController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/item/outcomings';
    $this->path = 'pages.backend.main.item.outcoming';
    $this->model = 'App\Models\Backend\Main\ItemOutcoming';
