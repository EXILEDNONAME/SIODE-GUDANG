...
use App\Http\Requests\Backend\Main\CategoryStock\StoreRequest;
use App\Http\Requests\Backend\Main\CategoryStock\UpdateRequest;
...
class CategoryStockController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/category-stocks';
    $this->path = 'pages.backend.main.category-stock';
    $this->model = 'App\Models\Backend\Main\CategoryStock';
