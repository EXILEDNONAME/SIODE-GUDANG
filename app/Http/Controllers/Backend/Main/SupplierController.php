...
use App\Http\Requests\Backend\Main\Supplier\StoreRequest;
use App\Http\Requests\Backend\Main\Supplier\UpdateRequest;
...
class SupplierController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/suppliers';
    $this->path = 'pages.backend.main.supplier';
    $this->model = 'App\Models\Backend\Main\Supplier';
