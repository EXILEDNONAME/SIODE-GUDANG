<div class="form-group row">
  ...
  <div class="col-lg-8">
    {!! Form::select('id_category', category_catalogs(), (isset($data->id_category) ? $data->id_category : NULL), ['placeholder' => '- Select Category -', 'class' => 'form-control', 'required' => 'required']) !!}
    @error('id_category') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
  </div>
  <div class="col-lg-1">
    <a href="/dashboard/category-catalogs/create" target="_blank" class="btn btn-disable" data-toggle="tooltip" title="" data-placement="left" data-original-title="Add Category">
...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {{ Form::select('color', ['' => '- Select Color -', 'Red' => 'Red', 'Blue' => 'Blue', 'Yellow' => 'Yellow', 'Green' => 'Green', 'Other' => 'Other'], (isset($data->color) ? $data->color : ''), ['class' => $errors->has('color') ? 'form-control is-invalid' : 'form-control', 'required' => 'required']) }}
